  ...
  ($checkedConvert) {
    ...
    final val = BuildConfig(
      buildTargets: $checkedConvert(
        'targets',
        (v) => _buildTargetsFromJson(v as Map?),
      ),
      globalOptions: $checkedConvert(
        'global_options',
        (v) => (v as Map?)?.map(
          (k, e) =>
              MapEntry(k as String, GlobalBuilderConfig.fromJson(e as Map)),
        ),
      ),
      builderDefinitions: $checkedConvert(
        'builders',
        (v) => (v as Map?)?.map(
          (k, e) => MapEntry(k as String, BuilderDefinition.fromJson(e as Map)),
        ),
      ),
