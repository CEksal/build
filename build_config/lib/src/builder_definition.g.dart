...
const _$BuildToEnumMap = {BuildTo.source: 'source', BuildTo.cache: 'cache'};
...
PostProcessBuilderDefinition _$PostProcessBuilderDefinitionFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = PostProcessBuilderDefinition(
      builderFactory: $checkedConvert('builder_factory', (v) => v as String),
      import: $checkedConvert('import', (v) => v as String),
      inputExtensions: $checkedConvert(
        'input_extensions',
        (v) => (v as List<dynamic>?)?.map((e) => e as String),
      ),
      target: $checkedConvert('target', (v) => v as String?),
